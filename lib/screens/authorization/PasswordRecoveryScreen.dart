                ...
                children: [
                  ...
                  GestureDetector(
                    onTapDown: (_) {
                      setState(() {
                        _isPressed =
                            true; // Устанавливаем состояние _isPressed в true при нажатии
                      });
                    },
                    onTapUp: (_) {
                      Navigator.push(
                      ...
                      setState(() {
                        _isPressed =
                            false; // Устанавливаем состояние _isPressed в false при отпускании
                      });
                    },
                    onTapCancel: () {
                      setState(() {
                        _isPressed =
                            false; // Сбрасываем состояние _isPressed при отмене нажатия
                      });
                    },
  ...
  Widget _buildForm() {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 20),
        buildWhiteTextField(hintText: 'Код', obscureText: true),
        SizedBox(height: 35),
        Text(
          'После ввода полученного кода вы сможете\n'
